export const stepsRarr = [
  ...
  'Became entirely ready to have Cthulhu consume our murderous urges.',
  ...
  'Continued to keep track of our trail of destruction and when we slip up made amends to the survivors, if any.',
...
export const stepsAA = [
  ...
  'Sought through prayer and meditation to improve our conscious contact with our Higher Power, praying only for knowledge of its will for us and the power to carry that out.',
